...
public class FlightHubTemplateTest {
	...
	@Test
		public void multiCityTripConstructor() throws Exception {
			...
			SiteTemplate flightHub = SiteFactory.createSiteTemplate( SupportedSitesEnum.FLIGHTHUB, m_mockedTrip, m_mockedPermutationAlgorithm );
